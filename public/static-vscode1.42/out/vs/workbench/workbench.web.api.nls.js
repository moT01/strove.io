 ...
 * Copyright (c) Microsoft Corporation. All rights reserved.
 *--------------------------------------------------------*/
define("vs/workbench/workbench.web.api.nls", {
	...
	"vs/platform/undoRedo/common/undoRedoService": [
		"The following files have been closed: {0}.",
	...
	"vs/platform/userDataSync/common/abstractSynchronizer": [
		"Cannot sync {0} as its version {1} is not compatible with cloud {2}"
	],
	"vs/platform/userDataSync/common/extensionsSync": [
		"Skipped synchronizing extension {0}"
	],
	"vs/platform/userDataSync/common/keybindingsSync": [
		"Unable to sync keybindings as there are errors/warning in keybindings file.",
		"Unable to sync keybindings as there are errors/warning in keybindings file."
	],
	...
	"vs/platform/userDataSync/common/userDataSync": [
		"Sync",
		"Synchronize keybindings per platform.",
	...
	"vs/workbench/api/common/configurationExtensionPoint": [
		...
		"Configuration that can be configured only in the user settings when the extension is running locally, or only in the remote settings when the extension is running remotely.",
	...
	"vs/workbench/api/common/menusExtensionPoint": [
		...
		"(Optional) Condition which must be true to enable the command",
	...
	"vs/workbench/browser/parts/editor/editorPicker": [
		...
		"No matching opened editor found in active editor group",
		"List of opened editors is currently empty in active editor group",
	...
	"vs/workbench/browser/parts/editor/textDiffEditor": [
		"Text Diff Editor",
		"{0} readonly compare editor",
		"Readonly compare editor",
		"{0} compare editor",
		"Compare editor"
	],
	...
	"vs/workbench/browser/parts/notifications/notificationsStatus": [
		...
		"{0} New Notifications ({0} in progress)",
		"Status Message"
	],
	...
	"vs/workbench/browser/workbench.contribution": [
		...
		"Controls whether specific views will have a context menu entry allowing them to be moved to a new container. Currently, this setting only affects the outline view and views contributed by extensions.",
	...
	"vs/workbench/contrib/customEditor/browser/customEditors": [
		"VS Code's standard text editor",
		"Currently Active",
	...
	"vs/workbench/contrib/customEditor/browser/extensionPoint": [
		...
		"Unique identifier of the custom editor.",
	...
	"vs/workbench/contrib/customEditor/browser/webviewEditor.contribution": [
		"Configure which editor to use for a resource.",
		"Editor view type.",
		"Mime type the editor should be used for. This is used for binary files.",
		"Glob pattern the editor should be used for."
	],
	...
	"vs/workbench/contrib/debug/browser/debugActions": [
		...
		"Select a workspace folder to create a launch.json file in",
		"Start Debugging",
	...
	"vs/workbench/contrib/debug/browser/rawDebugSession": [
		"No debug adapter found. Can not send '{0}'.",
		"More Info"
	],
	...
	"vs/workbench/contrib/debug/browser/replViewer": [
		...
		"Repl group {0}, read eval print loop, debug"
	],
	...
	"vs/workbench/contrib/extensions/browser/extensionTipsService": [
		...
		"Show Recommendations",
		"The '{0}' extension is recommended as you have {1} installed on your system.",
		"Install",
		"Show Recommendations",
		"Show Recommendations",
	...
	"vs/workbench/contrib/extensions/browser/extensions.contribution": [
		...
		"Extension '{0}' is not installed. Make sure you use the full extension ID, including the publisher, e.g.: ms-vscode.csharp.",
	...
	"vs/workbench/contrib/extensions/browser/extensionsActions": [
		...
		"Install the language pack extension on '{0}' to enable it also there.",
		"Install the language pack extension locally to enable it also there.",
		...
		"Completed installing the extension {0}.",
		"Reload Now",
		"Reinstall Extension...",
		...
		"Successfully installed extensions in {0}. Please reload the window to enable them.",
		"Reload Window",
	...
	"vs/workbench/contrib/files/browser/fileActions": [
		...
		"The file to paste has been deleted or moved since you copied it. {0}"
	],
	...
	"vs/workbench/contrib/files/browser/views/emptyView": [
		"No Folder Opened",
		"Explorer Section: No Folder Opened"
	],
	...
	"vs/workbench/contrib/markers/browser/messages": [
		...
		"No problems have been detected in the current file so far.",
	...
	"vs/workbench/contrib/preferences/browser/preferencesEditor": [
		...
		"Default preferences. Readonly editor."
	],
	...
	"vs/workbench/contrib/preferences/browser/settingsWidgets": [
		...
		"Remove Exclude Item",
		"Edit Exclude Item",
		"Edit Exclude Item in settings.json",
		"Add Pattern",
		"Exclude Pattern...",
	...
	"vs/workbench/contrib/quickopen/browser/gotoLineHandler": [
		"Go to Line...",
		"Current Line: {0}, Column: {1}. Type a line number between 1 and {2} to navigate to.",
		"Current Line: {0}, Column: {1}. Type a line number to navigate to.",
	...
	"vs/workbench/contrib/remote/browser/remote": [
		...
		"The url to your project's Getting Started page",
		"The url to your project's documentation page",
		"The url to your project's feedback reporter",
		"The url to your project's issues list",
		"Get Started",
		"Read Documentation",
		"Provide Feedback",
		"Review Issues",
	...
	"vs/workbench/contrib/tasks/browser/abstractTaskService": [
		...
		"workspace file",
		"Only tasks version 2.0.0 permitted in .codeworkspace.",
		"user settings",
		...
		"configured tasks",
		"detected tasks",
		"Detecting tasks ({0} of {1}): {2} in progress",
		"Stop detecting",
	...
	"vs/workbench/contrib/terminal/browser/terminalInstance": [
		...
		"The terminal shell path \"{0}\" does not exist",
		"The terminal shell path \"{0}\" is a directory",
		"The terminal shell CWD \"{0}\" does not exist",
	...
	"vs/workbench/contrib/timeline/browser/timeline.contribution": [
		"Timeline",
		"Experimental: When enabled, shows a Timeline view in the Explorer sidebar.",
	...
	"vs/workbench/contrib/userDataSync/browser/userDataSync": [
		...
		"{0} (synced {1})",
		"Sync: Turn on Sync",
		"Sync: Sign in to sync",
		"Sync: Turn off Sync",
		"Sync: Show Settings Conflicts",
		"Sync: Show Keybindings Conflicts",
		"Sync: Configure",
		"Sync: Show Log",
		"Sync: Settings",
		...
		"Sign in",
		"Sync was turned off from another device.",
		"Turn on Sync",
		...
		"Open {0} File",
		"Turned off sync because local data is incompatible with the data in the cloud. Please update {0} and turn on sync to continue syncing.",
		"Unable to sync {0} because there are some errors/warnings in the file. Please open the file to correct errors/warnings in it.",
		"Open {0} File",
		"Sign in to Sync",
		...
		"Sync: Turn On",
		"Turn On",
		"Sign in with your {0} account to synchronize your data across devices.",
		"Sign in & Turn on",
		"Choose what to sync",
		"{0}: Pick an account",
		"Pick an account for syncing",
		"{0}",
		"Signed in",
		"Use another account",
		"Sync will happen automatically from now on.",
		"only 'Display Language' for now",
		"Turn on Sync",
		"Choose what to sync",
		"Sync",
		"Merge",
		"Cancel",
		"Replace Local",
		"It looks like this is the first time sync is set up.\nWould you like to merge or replace with the data from the cloud?",
		"Turn off Sync",
		"Your settings, keybindings, extensions and UI State will no longer be synced.",
		"Turn Off",
		"Turn off sync on all your devices and clear the data from the cloud.",
		"Logging in failed: {0}",
		"Settings Conflicts (Remote ↔ Local)",
		"Keybindings Conflicts (Remote ↔ Local)",
		"Error while starting Sync: {0}",
		"Turn on Sync...",
		"Turn on Sync...",
		"Sync: Show Settings Conflicts (1)",
		"Sync: Show Settings Conflicts (1)",
		"Sync: Show Keybindings Conflicts (1)",
		"Sync: Show Keybindings Conflicts (1)",
		"Sync is on",
		"Error while turning off sync: {0}",
		"Accept Remote",
		"Accept Local",
		"Sync: {0}",
		"Sync: {0}",
		"Would you like to accept Remote {0} and replace Local {1}?",
		"Would you like to accept Local {0} and replace Remote {1}?",
	...
	"vs/workbench/contrib/welcome/common/viewsWelcomeContribution": [
		"The '{0}' contribution is a proposed API and is only available when running out of dev or with the following command line switch: --enable-proposed-api {1}"
	],
	"vs/workbench/contrib/welcome/common/viewsWelcomeExtensionPoint": [
		...
		"Target view identifier for this welcome content.",
	...
	"vs/workbench/services/extensions/browser/webWorkerExtensionHostStarter": [
	...
	"vs/workbench/services/keybinding/browser/keymapService": [
		"Keyboard",
	...
	"vs/workbench/services/themes/common/tokenClassificationExtensionPoint": [
		...
		"Contributes semantic token style defaults.",
		"The selector matching token types and modifiers.",
		"Selectors should be in the form (type|*)(.modifier)*",
		"A TextMate scope against the current color theme is matched to find the style for the given selector",
		"The default style used for light themes",
		"The default style used for dark themes",
		"The default style used for high contrast themes",
		...
		"'configuration.{0}.foreground'  must follow the pattern #RRGGBB[AA]",
		"'configuration.{0}.fontStyle'  must be one or a combination of  'italic', 'bold' or 'underline' or the empty string",
		"'configuration.semanticTokenType' must be an array",
		"'configuration.semanticTokenModifier' must be an array",
		"'configuration.semanticTokenStyleDefaults' must be an array",
		"'configuration.semanticTokenStyleDefaults.selector' must be defined and can not be empty",
		"'configuration.semanticTokenStyleDefaults.selector' must be in the form (type|*)(.modifier)*",
		"If defined, 'configuration.semanticTokenStyleDefaults.scope' must be an array of strings",
		"configuration.semanticTokenStyleDefaults.selector': Problems parsing {0}."
	],
