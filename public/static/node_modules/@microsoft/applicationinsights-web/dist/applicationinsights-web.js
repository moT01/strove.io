/*!
 * Application Insights JavaScript SDK - Web, 2.1.1
        ...
        */
        PageViewManager.prototype.trackPageView = function (pageView, customProperties) {
            ...
            if (!this._pageViewPerformanceManager.isPerformanceTimingSupported()) {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.WARNING, _InternalMessageId.NavigationTimingNotSupported, "trackPageView: navigation timing API used for calculation of page duration is not supported in this browser. This page view will be collected without duration and timing info.");
                return;
            }
            ...
            var handle = setInterval((function () {
                try {
                    ...
                    _this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.TrackPVFailedCalc, "trackPageView failed on page load calculation: " + Util.getExceptionName(e), { exception: Util.dump(e) });
                }
            }), 100);
        };
    ...
    var ApplicationInsights = /** @class */ (function () {
            ...
            for (var i = 0; i < telemetryInitializersCount; ++i) {
                ...
                if (telemetryInitializer) {
                    try {
                        ...
                        // doNotSendItem = true;
                        this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.TelemetryInitializerFailed, "One of telemetry initializers failed, telemetry item will not be sent: " + Util.getExceptionName(e), { exception: Util.dump(e) }, true);
                    }
                }
            }
        ...
        ApplicationInsights.prototype.trackEvent = function (event, customProperties) {
            try {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.WARNING, _InternalMessageId.TrackTraceFailed, "trackTrace failed, trace will not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        /**
        ...
        */
        ApplicationInsights.prototype.startTrackEvent = function (name) {
            try {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.StartTrackEventFailed, "startTrackEvent failed, event will not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        /**
        ...
        ApplicationInsights.prototype.stopTrackEvent = function (name, properties, measurements) {
            try {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.StopTrackEventFailed, "stopTrackEvent failed, event will not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        /**
        ...
        ApplicationInsights.prototype.trackMetric = function (metric, customProperties) {
            try {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.TrackMetricFailed, "trackMetric failed, metric will not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        /**
        ...
        ApplicationInsights.prototype.trackPageView = function (pageView, customProperties) {
            try {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.TrackPVFailed, "trackPageView failed, page view will not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        /**
        ...
        ApplicationInsights.prototype.trackPageViewPerformance = function (pageViewPerformance, customProperties) {
            try {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.TrackPVFailed, "trackPageViewPerformance failed, page view will not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        /**
        ...
        ApplicationInsights.prototype.startTrackPage = function (name) {
            try {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.StartTrackFailed, "startTrackPage failed, page view may not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        /**
        ...
        ApplicationInsights.prototype.stopTrackPage = function (name, url, properties, measurement) {
            try {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.StopTrackFailed, "stopTrackPage failed, page view will not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        /**
        * @ignore INTERNAL ONLY
        ...
        */
        ...
        ApplicationInsights.prototype.trackException = function (exception, customProperties) {
            try {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.TrackExceptionFailed, "trackException failed, exception will not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        /**
        ...
        ApplicationInsights.prototype._onerror = function (exception) {
            try {
                ...
                var errorString = exception.error ?
                    ...
                    : "null";
                this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.ExceptionWhileLoggingError, "_onError threw exception while logging error, error will not be collected: "
            ...
            if (!source.aiDataContract) {
                ...
                if (name === "measurements") {
                    ...
                    try {
                        ...
                        this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.CannotSerializeObject, (e && typeof e.toString === 'function') ? e.toString() : "Error serializing object", null, true);
                    }
                }
                return output;
            }
    ...
    var Sender = /** @class */ (function () {
        ...
        Sender.prototype.flush = function () {
            try {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.FlushFailed, "flush failed, telemetry will not be collected: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
        };
        ...
        Sender.prototype.processTelemetry = function (telemetryItem) {
            ...
            try {
                ...
                // validate input
                if (!telemetryItem) {
                    this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.CannotSendEmptyTelemetry, "Cannot send empty telemetry");
                    return;
                }
                // validate event
                if (telemetryItem.baseData && !telemetryItem.baseType) {
                    this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.InvalidEvent, "Cannot send telemetry without baseData and baseType");
                    return;
                }
                ...
                if (!this._sender) {
                    this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.SenderNotInitialized, "Sender was not initialized");
                    return;
                }
                // check if this item should be sampled in, else add sampleRate tag
                if (!this._isSampledIn(telemetryItem)) {
                    // Item is sampled out, do not send it
                    this._logger.throwInternal(exports.LoggingSeverity.WARNING, _InternalMessageId.TelemetrySampledAndNotSent, "Telemetry item was sampled out and not sent", { SampleRate: this._sample.sampleRate });
                    return;
                }
                else {
                ...
                if (!aiEnvelope_1) {
                    this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.CreateEnvelopeError, "Unable to create an AppInsights envelope");
                    return;
                }
                ...
                if (telemetryItem.tags && telemetryItem.tags[ProcessLegacy]) {
                    telemetryItem.tags[ProcessLegacy].forEach(function (callBack) {
                        try {
                            ...
                            // log error but dont stop executing rest of the telemetry initializers
                            // doNotSendItem = true;
                            _this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.TelemetryInitializerFailed, "One of telemetry initializers failed, telemetry item will not be sent: " + Util.getExceptionName(e), { exception: Util.dump(e) }, true);
                        }
                    });
                ...
                this._logger.throwInternal(exports.LoggingSeverity.WARNING, _InternalMessageId.FailedAddingTelemetryToBuffer, "Failed adding telemetry to the sender's buffer, some telemetry will be lost: " + Util.getExceptionName(e), { exception: Util.dump(e) });
            }
            ...
            if (xhr.readyState === 4) {
                ...
                if ((xhr.status < 200 || xhr.status >= 300) && xhr.status !== 0) {
                    if (!this._config.isRetryDisabled() && this._isRetriable(xhr.status)) {
                        ...
                        this._logger.throwInternal(exports.LoggingSeverity.WARNING, _InternalMessageId.TransmissionFailed, ". " +
                    ...
                    if (!this._config.isRetryDisabled()) {
                        ...
                        this._logger.throwInternal(exports.LoggingSeverity.WARNING, _InternalMessageId.TransmissionFailed, ". Offline - Response Code: " + xhr.status + ". Offline status: " + Offline.isOffline() + ". Will retry to send " + payload.length + " items.");
                    }
                }
                else {
                    if (xhr.status === 206) {
        ...
        Sender.prototype.triggerSend = function (async) {
            ...
            try {
                ...
                if (!Util.getIEVersion() || Util.getIEVersion() > 9) {
                    this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.TransmissionFailed, "Telemetry transmission failed, some telemetry will be lost: " + Util.getExceptionName(e), { exception: Util.dump(e) });
                }
            }
        };
        /**
        ...
        Sender.prototype._onError = function (payload, message, event) {
            this._logger.throwInternal(exports.LoggingSeverity.WARNING, _InternalMessageId.OnError, "Failed to send telemetry.", { message: message });
        ...
        Sender.prototype._onPartialSuccess = function (payload, results) {
            ...
            if (retry.length > 0) {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.WARNING, _InternalMessageId.TransmissionFailed, "Partial success. " +
        ...
        Sender.prototype._beaconSender = function (payload, isAsync) {
            ...
            if (queued) {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.WARNING, _InternalMessageId.TransmissionFailed, ". " + "Failed to send telemetry with Beacon API, retried with xhrSender.");
            }
        };
        /**
         * Send XMLHttpRequest
        ...
        Sender.prototype._parseResponse = function (response) {
            try {
                ...
                this._logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.InvalidBackendResponse, "Cannot parse the response. " + Util.getExceptionName(e), {
                    response: response
                });
            }
            return null;
    ...
    var AjaxMonitor = /** @class */ (function () {
        ...
        AjaxMonitor.prototype.instrumentOpen = function () {
            ...
            XMLHttpRequest.prototype.open = function (method, url, async) {
                try {
                    ...
                    ajaxMonitorInstance._core.logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.FailedMonitorAjaxOpen, "Failed to monitor XMLHttpRequest.open, monitoring data for this ajax call may be incorrect.", {
        ...
        AjaxMonitor.prototype.instrumentSend = function () {
            ...
            XMLHttpRequest.prototype.send = function (content) {
                try {
                    ...
                    ajaxMonitorInstance._core.logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.FailedMonitorAjaxSend, "Failed to monitor XMLHttpRequest, monitoring data for this ajax call may be incorrect.", {
                        ajaxDiagnosticsMessage: AjaxMonitor.getFailedAjaxDiagnosticsMessage(this),
                        exception: Util.dump(e)
                    });
                }
        ...
        AjaxMonitor.prototype.instrumentAbort = function () {
            ...
            XMLHttpRequest.prototype.abort = function () {
                try {
                    ...
                    ajaxMonitorInstance._core.logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.FailedMonitorAjaxAbort, "Failed to monitor XMLHttpRequest.abort, monitoring data for this ajax call may be incorrect.", {
                        ajaxDiagnosticsMessage: AjaxMonitor.getFailedAjaxDiagnosticsMessage(this),
                        exception: Util.dump(e)
                    });
                }
            ...
            xhr.ajaxData.xhrMonitoringState.onreadystatechangeCallbackAttached = EventHelper.AttachEvent(xhr, "readystatechange", function () {
                try {
                    ...
                    if (!exceptionText || exceptionText.toLowerCase().indexOf("c00c023f") == -1) {
                        ajaxMonitorInstance._core.logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.FailedMonitorAjaxRSC, "Failed to monitor XMLHttpRequest 'readystatechange' event handler, monitoring data for this ajax call may be incorrect.", {
        ...
        AjaxMonitor.prototype.onAjaxComplete = function (xhr) {
            ...
            if (xhr.ajaxData.ajaxTotalDuration < 0) {
                this._core.logger.throwInternal(exports.LoggingSeverity.WARNING, _InternalMessageId.FailedMonitorAjaxDur, "Failed to calculate the duration of the ajax call, monitoring data for this ajax call won't be sent.", {
                    ajaxDiagnosticsMessage: AjaxMonitor.getFailedAjaxDiagnosticsMessage(xhr),
        ...
        AjaxMonitor.prototype.getAjaxCorrelationContext = function (xhr) {
            try {
                ...
                this._core.logger.throwInternal(exports.LoggingSeverity.WARNING, _InternalMessageId.FailedMonitorAjaxGetCorrelationHeader, "Failed to get Request-Context correlation header as it may be not included in the response or not accessible.", {
                    ajaxDiagnosticsMessage: AjaxMonitor.getFailedAjaxDiagnosticsMessage(xhr),
                    exception: Util.dump(e)
                });
            }
        ...
        AjaxMonitor.prototype.trackDependencyDataInternal = function (dependency, properties, systemProperties) {
            if (this._config.maxAjaxCallsPerView === -1 || this._trackAjaxAttempts < this._config.maxAjaxCallsPerView) {
                ...
                this._core.logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.MaxAjaxPerPVExceeded, "Maximum ajax per page view limit reached, ajax monitoring is paused until the next trackPageView(). In order to increase the limit set the maxAjaxCallsPerView configuration parameter.", true);
            }
            ...
            window.fetch = function fetch(input, init) {
                ...
                if (fetchMonitorInstance.isFetchInstrumented(input) && fetchMonitorInstance.isMonitoredInstance(undefined, undefined, input, init)) {
                    try {
                        ...
                        fetchMonitorInstance._core.logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.FailedMonitorAjaxOpen, "Failed to monitor Window.fetch, monitoring data for this fetch call may be incorrect.", {
        ...
        AjaxMonitor.prototype.getFailedFetchDiagnosticsMessage = function (input) {
            ...
            try {
                ...
                this._core.logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.FailedMonitorAjaxOpen, "Failed to grab failed fetch diagnostics message", { exception: Util.dump(e) });
            }
            return result;
        };
        AjaxMonitor.prototype.onFetchComplete = function (response, ajaxData) {
            ...
            try {
                ...
                if (ajaxData.ajaxTotalDuration < 0) {
                    this._core.logger.throwInternal(exports.LoggingSeverity.WARNING, _InternalMessageId.FailedMonitorAjaxDur, "Failed to calculate the duration of the fetch call, monitoring data for this fetch call won't be sent.", {
                ...
                this._core.logger.throwInternal(exports.LoggingSeverity.WARNING, _InternalMessageId.FailedMonitorAjaxGetCorrelationHeader, "Failed to calculate the duration of the fetch call, monitoring data for this fetch call won't be sent.", {
                    fetchDiagnosticsMessage: this.getFailedFetchDiagnosticsMessage(response),
                    exception: Util.dump(e)
                });
            }
        ...
        AjaxMonitor.prototype.onFetchFailed = function (input, ajaxData, reason) {
            ...
            try {
                ...
                ajaxData.CalculateMetrics();
                if (ajaxData.ajaxTotalDuration < 0) {
                    this._core.logger.throwInternal(exports.LoggingSeverity.WARNING, _InternalMessageId.FailedMonitorAjaxDur, "Failed to calculate the duration of the failed fetch call, monitoring data for this fetch call won't be sent.", {
                ...
                this._core.logger.throwInternal(exports.LoggingSeverity.WARNING, _InternalMessageId.FailedMonitorAjaxGetCorrelationHeader, "Failed to calculate the duration of the failed fetch call, monitoring data for this fetch call won't be sent.", {
                    fetchDiagnosticsMessage: this.getFailedFetchDiagnosticsMessage(input),
                    exception: Util.dump(e)
                });
            }
        ...
        Initialization.prototype.addHousekeepingBeforeUnload = function (appInsightsInstance) {
            ...
            if (!appInsightsInstance.appInsights.config.disableFlushOnBeforeUnload && ('onbeforeunload' in window)) {
                ...
                if (!Util.addEventHandler('beforeunload', performHousekeeping)) {
                    appInsightsInstance.appInsights.core.logger.throwInternal(exports.LoggingSeverity.CRITICAL, _InternalMessageId.FailedToAddHandlerForOnBeforeUnload, 'Could not add handler for beforeunload');
                }
            }
        };
