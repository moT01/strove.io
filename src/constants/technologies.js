...
export default [
  {
    component: (
      <Docker fill="#fff" style={{ fill: '#303c42' }} width="100%" length="auto" />
    ),
    name: 'Docker',
    description:
  ...
  {
    component: <Google style={{ fill: '#303c42' }} width="100%" length="auto" />,
    name: 'Google',
    description:
      'Google Cloud allows us to host secure, consistent cloud environment.',
  },
  {
    component: <VSCode style={{ fill: '#303c42' }} width="100%" length="auto" />,
    name: 'VSCode',
    description:
      'Strove.io supports VSCode to provide the best programming experience.',
  },
  {
    component: <Github style={{ fill: '#303c42 ' }} width="100%" length="auto" />,
    name: 'Github',
    description:
