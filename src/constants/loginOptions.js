...
export default [
  {
    ...
    embedHref: `https://github.com/login/oauth/authorize?client_id=${GITHUB_CLIENT_ID}&scope=user,user:email,public_repo&state=github,${IS_OPENSOURCE},${SILISKY_URL}fromEmbed/goBackTo/`,
    icon: <Github />,
  },
  {
    value: 'bitbucket',
    ...
    embedHref: `https://bitbucket.org/site/oauth2/authorize?client_id=${BITBUCKET_CLIENT_ID}&response_type=code&state=bitbucket,${IS_OPENSOURCE},${SILISKY_URL}fromEmbed/goBackTo/`,
    icon: <Bitbucket />,
  },
  {
    value: 'gitlab',
    ...
    embedHref: `https://gitlab.com/oauth/authorize?client_id=${GITLAB_CLIENT_ID}&redirect_uri=${REDIRECT_URI}&response_type=code&state=gitlab,${IS_OPENSOURCE},${SILISKY_URL}fromEmbed/goBackTo/`,
    icon: <Gitlab />,
  },
]
