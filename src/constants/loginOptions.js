...
export default [
  {
    ...
    embedHref: `https://github.com/login/oauth/authorize?client_id=${GITHUB_CLIENT_ID}&scope=user,user:email,public_repo&state=github,$true,${SILISKY_URL}goBackTo/`,
    icon: <Github />,
  },
  {
    value: 'bitbucket',
    ...
    embedHref: `https://bitbucket.org/site/oauth2/authorize?client_id=${BITBUCKET_CLIENT_ID}&response_type=code&state=bitbucket,true,${SILISKY_URL}goBackTo/`,
    icon: <Bitbucket />,
  },
  {
    value: 'gitlab',
    ...
    embedHref: `https://gitlab.com/oauth/authorize?client_id=${GITLAB_CLIENT_ID}&redirect_uri=${REDIRECT_URI}&response_type=code&state=gitlab,true,${SILISKY_URL}goBackTo/`,
    icon: <Gitlab />,
  },
]
