  ...
  <>
    ...
    <TextWell>
      ...
      <p>
        ...
        relationship with (https://silisky.com) website (the "Service") and the
        (Silisky) creation service therein operated by (SiliSky)(„us”, "we", or
        "our"). Please read these Terms and Conditions carefully before using
        the Service. Your access to and use of the Service is conditioned on
        your acceptance of and compliance with these Terms. These Terms apply to
        all visitors, users and others who access or use the Service. Any
        information submitted by you shall be subject to (SiliSky’s) Privacy
        Policy. One person or legal entity may not maintain more than one
        Account. Accounts registered by “bots” or other automated methods are
        not permitted. By accessing or using the Service you agree to be bound
      ...
      <p>
        ...
        renew under the exact same conditions unless you cancel it or (SiliSky)
        cancels it. You may cancel your Subscription renewal either through your
        online account management page or by contacting (SiliSky) customer
        support team.
      </p>
      <p>
        {' '}
      ...
      <p>
        ...
        you specifically save a (Prawdopodobnie Projekt/Sandbox) as private to
        (SiliSky), and that (Prawdopodobnie Projekt/Sandbox) has never been
        public on (SiliSky) or anywhere else, the code in that particular
      ...
      <p>
        ...
        are not owned or controlled by (SiliSky).
      </p>
      <p>
        (SiliSky).has no control over, and assumes no responsibility for, the
        content, privacy policies, or practices of any third party web sites or
        services. You further acknowledge and agree that (SiliSky) shall not be
      ...
      <p>
        (SiliSky) its subsidiaries, affiliates, and its licensors do not warrant
