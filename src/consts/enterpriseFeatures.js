export default [
  ...
  },
  {
    ...
    content:
      'With completely remote development environment leasing computers for each developer is no longer a necessity but an option. Because the code runs on the cloud server, it will work consistently, regardless of the device.',
    color: '#EB2F96',
